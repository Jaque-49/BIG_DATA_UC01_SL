...
df_cvli_geral = df_ocorrencias[['aisp','cvli']]
# Criando o DataFrame dos crimes violentos letais intencionais 
df_cvli_geral = df_cvli_geral[df_cvli_geral['cvli'].isin(["Rio de Janeiro"])]
df_cvli_geral = df_cvli_geral.groupby(['aisp']).sum(['recuperacao_veiculos']).reset_index()
