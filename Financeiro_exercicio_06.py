...
print(f"\nA média da renda dos clientes é {media_renda:.2f}")
print(f"A mediana da renda dos clientes é {mediana_renda:.2f}")
print(f"A distância entre a média e a mediana da renda dos clientes  é {distancia_renda:.2f} %")
print(f"O menor valor da renda dos clientes é {minimo_renda:.2f}")
print(f"O maior valor da renda dos clientes  é {maximo_renda:.2f}")
...
print(f"\nA média dos valores emprestados dos clientes é {media_valor_emprestado:.2f}")
print(f"A mediana dos valores emprestados aos clientes é {mediana_valor_emprestado:.2f}")
print(f"A distância entre a média e a mediana dos valores emprestados aos clientes  é {distancia_valor_emprestado:.2f} %")
print(f"O menor dos valores emprestados clientes é {minimo_valor_emprestado:.2f}")
print(f"O maior dos valores emprestados clientes  é {maximo_valor_emprestado:.2f}")
