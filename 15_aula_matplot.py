...
df_financeira_renda_emprestimo_order = df_financeira_renda_emprestimo.sort_values(by='Renda', asceding=True)
plt.subplot(2,2,1)
plt.xticks([])
plt.title('Acumulado dos Valores')
...
df_financeira_renda_emprestimo_order = df_financeira_renda_emprestimo.sort_values(by='Vlr_emprestado', asceding=True)
plt.subplot(2,2,2)
#plt.xticks([])
plt.title('Acumulado dos Valores')
...
plt.text(0.1,0.8,f'Valor Médio da mediana é {media_renda:.2f}',fontsize=12)
plt.text(0.1,0.7,f'Distânia da Média e da mediana é {distancia_renda:.2f}',fontsize=12)
plt.text(0.1,0.6,f'Valor mínimo {minimo_renda:.2f}',fontsize=12)
plt.text(0.1,0.5,f'Valor máximo {maximo_renda:.2f}',fontsize=12)
plt.text(0.1,0.4,f'Amplitude {amplitude_renda:.2f}',fontsize=12)
...
plt.text(0.1,0.8,f'Valor emprestado da mediana é {mediana_vlr_emprestado:.2f}',fontsize=12)
plt.text(0.1,0.7,f'Distânia da Média e da mediana do valor emprestado {distancia_vlr_emprestado:.2f}',fontsize=12)
plt.text(0.1,0.6,f'Valor mínimo do valor emprestado {minimo_vlr_emprestado:.2f}',fontsize=12)
plt.text(0.1,0.5,f'Valor máximo do valor emprestado {maximo_vlr_emprestado:.2f}',fontsize=12)
plt.text(0.1,0.4,f'Amplitude do valor emprestado {amplitude_vlr_emprestado:.2f}',fontsize=12)
